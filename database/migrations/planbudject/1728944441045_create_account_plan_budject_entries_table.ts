...
export default class extends BaseSchema {
  protected tableName = 'account_plan_budject_entries'
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('account_plan_budject_id').notNullable().unsigned().references('account_plan_budjects.id')
      table.integer('account_plan_id').notNullable().unsigned().references('account_plans.id')
      table.integer('parent_id').unsigned().references('account_plan_budject_entries.id')
